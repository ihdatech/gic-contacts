...
enum AppErrorType { network, badRequest, unauthorized, cancel, timeout, server, unknown }
...
class AppError {
  ...
  AppError(Exception? error) {
    if (error is DioError) {
      debugPrint('AppError(DioError): type is ${error.type}, message is ${error.message}');
